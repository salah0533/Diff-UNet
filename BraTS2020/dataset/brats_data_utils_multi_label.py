...
def get_loader_brats(data_dir, batch_size=1, fold=0, num_workers=8):
    ...
    train_files = [os.path.join(data_dir, d) for d in train_test_split_brats20['train']][0]
    test_files = [os.path.join(data_dir, d) for d in train_test_split_brats20['test']][0]
    val_files = [os.path.join(data_dir, d) for d in train_test_split_brats20['test']][0]
